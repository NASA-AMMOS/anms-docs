...
ARIs with complex parameters include additional guidance for populating these required fields. For instance, an ARI Collection (AC) builder is provided for ARIs requiring an AC parameter, as shown in <<fig-ari-parms>>. The left side of the screen allows a user to search for the ARI they want to add to the AC and the right-hand side of the screen displays the selected ARI(s). 
...
== References
[bibliography]
* [[[anms-product-guide,ANMS Product Guide]]] "Asynchronous Network Management System Product Guide," JHU/APL

* [[[grafana-docs]]] https://grafana.com/docs/ 

* [[[grafana-dashboard]]] https://grafana.com/docs/grafana/latest/getting-started/build-first-dashboard/
